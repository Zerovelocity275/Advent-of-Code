...
# Part 1 in one line :)
print(sum([int(str([character for character in line if character.isnumeric()][0])+str([character for character in line if character.isnumeric()][-1])) for line in open('Input/Day 1.txt', 'r').read().splitlines()]))
